...
const Contact = ({ profile }) => {
  ...
  const handleChange = (e) => {
    ...
    // Clear any field errors when user edits that field
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setErrorMessage(response.data.message || 'There was an error sending your message. Please try again.');
      }
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="inline-block">
            <span className="inline-block px-3 py-1 rounded-full text-sm font-semibold bg-indigo-900/40 text-indigo-300 mb-3">
              Contact Me
            </span>
            ...
            <div className="space-y-6">
              ...
              {profile.resume_url && (
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-white">Resume</h4>
                    <a
                ...
                {submitSuccess ? (
                  <div className="p-4 rounded-md bg-green-900/30 border border-green-700">
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <h3 className="text-sm font-medium text-green-200">Message sent successfully</h3>
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className={`block w-full px-4 py-3 rounded-md border focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-700 text-white ${
