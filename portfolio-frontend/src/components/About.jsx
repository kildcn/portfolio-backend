      ...
      <div key={category} className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {skills.map((skill) => (
            <span
              key={skill}
              className="px-3 py-1.5 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900/40 dark:text-indigo-300 hover:bg-indigo-200 dark:hover:bg-indigo-900/60 transition-colors duration-200"
            >
              {skill}
            </span>
          ))}
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                ...
                {profile.email && (
                  <div className="mt-10 p-6 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
